...
frontdesk_frontend_stack = LSITStack(
    ...
    network_stack.load_balancer,
    {
        ...
        "certificate_arns": ["arn:aws:acm:us-west-2:042277129213:certificate/91ff795e-0e8e-4e9a-98e5-f6b1d3531232", "arn:aws:acm:us-west-2:042277129213:certificate/8473ef06-4248-46aa-bd64-27c856d4de32"],
        "is_private": True,
...
LSITStack(
    ...
    network_stack.load_balancer,
    {
        ...
        "certificate_arns": ["arn:aws:acm:us-west-2:042277129213:certificate/001ed34c-9184-429b-8605-232dd0bfbcf2"],
        "is_private": True,
...
LSITStack(
    ...
    network_stack.load_balancer,
    {
        ...
        "certificate_arns": ["arn:aws:acm:us-west-2:042277129213:certificate/7bf885a7-7d3f-4b85-80b8-b8d99197b9fa"],
        "is_private": True,
...
qualtrics_tools_staging_stack = LSITStack(
    ...
    network_stack.load_balancer,
    {
        ...
        "certificate_arns": ["arn:aws:acm:us-west-2:042277129213:certificate/048e7aa9-13ca-4f00-ac26-3ff4a6f7b207"],
        "is_private": True
    },
    env=Environment(account=CDK_DEFAULT_ACCOUNT, region=CDK_DEFAULT_REGION),
)
...
lsit_coal_stack = LSITStack(
    ...
    network_stack.load_balancer,
    {
        ...
        "certificate_arns": ["arn:aws:acm:us-west-2:042277129213:certificate/90ea61e3-13cf-48ad-b549-8bd867ff3c79"],
        "is_private": True,
        "monitoring_stack": monitoring_stack
    },
    env=Environment(account=CDK_DEFAULT_ACCOUNT, region=CDK_DEFAULT_REGION),
...
ucpath_audit_stack = LSITStack(
    ...
    dx_network_stack.load_balancer,
    {
        ...
        "certificate_arns": ["arn:aws:acm:us-west-2:042277129213:certificate/908aed23-6105-4d28-9d65-d3f4ddac939c"],
        "is_private": True,
        "monitoring_stack": monitoring_stack
    },
    env=Environment(account=CDK_DEFAULT_ACCOUNT, region=CDK_DEFAULT_REGION),
